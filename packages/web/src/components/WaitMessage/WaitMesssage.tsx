          ...
          <Message icon={true} info>
            ...
            <Message.Content>
              ...
              <div style={{ marginTop: "15px" }}>
                ...
                />
                <p style={{ marginTop: "10px" }}> Share this Game ID with friends so they can join your game!</p>
                <p>The game will start automatically once 6 total players have joined.</p>
              </div>
            </Message.Content >
          </Message >
        );
        ...
        return (
          <Message icon={true} hidden={!this.canShowWaitMessage}>
            ...
            <Message.Content>
              ...
              The game creator is setting up the game. You'll be connected once the game starts.
            </Message.Content>
          </Message>
        );
      }
  ...
  private copyGameId = () => {
    if (this.gameInfo.sharedGameId) {
      navigator.clipboard.writeText(this.gameInfo.sharedGameId).then(() => {
        ...
        const button = document.querySelector('[data - testid="wait-copy-button"]') as HTMLElement;
        if (button) {

      ...
      <Message icon={true} info>
        ...
        <Message.Content>
          ...
          <Segment>
            ...
            <p>
              Choose how many bot players to add. The game needs exactly 6 total
              players.
            </p>
            <p>
              <strong>0 Bots:</strong> Wait for 5 human players to join (6
              humans total)
            </p>
            <p>
              <strong>5 Bots:</strong> Start game immediately (1 human + 5 bots)
            </p>
            <p>
              <strong>1-4 Bots:</strong> Wait for more human players to join
            </p>
